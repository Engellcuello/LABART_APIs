...
from API.vistas.resourses.codeOTP import EmailSender, PasswordResetComplete, PasswordResetCompleteNoOTP, PasswordResetInit, PasswordResetVerify, VerifyCurrentPassword, CambioContrasena
...
#Endpoint de verificar nombre de usuario
api.add_resource(CambioContrasena, '/cambio-contrasena')
...
#     db.session.commit()
    ...
    # # tabla Reaccion
    # reaccion1 = Reaccion(Nombre_reaccion='Like',  Descripcion_reaccion='Me gusta')
    # reaccion2 = Reaccion(Nombre_reaccion='Love', Img_reaccion='', Descripcion_reaccion='Me encanta')
    # reaccion3 = Reaccion(Nombre_reaccion='Wow', Img_reaccion='', Descripcion_reaccion='Me sorprende')
    # reaccion4 = Reaccion(Nombre_reaccion='dislike', Img_reaccion='', Descripcion_reaccion='No me gusta')
    # db.session.add_all([reaccion1, reaccion2, reaccion3, reaccion4])
    # db.session.commit()

    # # tabla tipo reaccion
    # tipo_reaccion1 = TipoNotificacion(Nombre='nuevo seguidor', Mensaje_base='A {usuario} empezó a seguirte!')
    # tipo_reaccion2 = TipoNotificacion(Nombre='Like publicación', Mensaje_base='A {usuario} le gustó tu publicación')
    # tipo_reaccion3 = TipoNotificacion(Nombre='Love publicacion', Mensaje_base='A {usuario} le encanto tu publicacion')
    # tipo_reaccion4 = TipoNotificacion(Nombre='wow publicacion', Mensaje_base='A {usuario} le sorprendo tu publicacion')
    # tipo_reaccion5 = TipoNotificacion(Nombre='dislike publicacion', Mensaje_base='A {usuario} no le gusto tu publicacion')
    # tipo_reaccion6 = TipoNotificacion(Nombre='Nuevo comentario', Mensaje_base='{usuario} comentó en tu publicación')
    # db.session.add_all([tipo_reaccion1, tipo_reaccion2, tipo_reaccion3, tipo_reaccion4, tipo_reaccion5, tipo_reaccion6])
    # db.session.commit()
