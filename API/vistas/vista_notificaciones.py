...
class VistaNotificacionesUsuario(Resource):
    def get(self, id_usuario):
        """
        Obtiene todas las notificaciones de un usuario organizadas en 3 categorías:
        1. Comentarios (tipo notificación 3)
        2. Reacciones (tipos 2)
        ...
        notificaciones = db.session.query(
            ...
            Publicacion.ID_publicacion.label('id_publicacion_publicacion') #Cambio nuevo
        ...
        # Inicializar las tres listas
        comentarios = []
        reacciones = []

        # Clasificar las notificaciones
        for notif in notificaciones:
            notificacion_data = {
                ...
                'id_publicacion': notif.id_publicacion_publicacion #Cambio nuevo

            }

            # Clasificar según el tipo
            if notif.id_tipo == 3:  # Comentarios
                comentarios.append(notificacion_data)
            elif notif.id_tipo in [2]:  # Reacciones
